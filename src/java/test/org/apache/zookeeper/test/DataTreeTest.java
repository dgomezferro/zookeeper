...
public class DataTreeTest extends ZKTestCase {
    ...
    public void testRootWatchTriggered() throws Exception {
        ...
        dt.createNode("/xyz", new byte[0], null, 0, false, dt.getNode("/").stat.getCversion()+1, 1, 1);
    ...
    public void testIncrementCversion() throws Exception {
        dt.createNode("/test", new byte[0], null, 0, false, dt.getNode("/").stat.getCversion()+1, 1, 1);
